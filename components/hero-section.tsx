...
import { PhoneCall, Store, ArrowDown } from "lucide-react"
        ...
        <div className="max-w-5xl mx-auto space-y-6 lg:space-y-10 text-center" data-animate="fade-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            <Button
              asChild
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-8 py-6 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-primary/50 h-auto"
            >
              <a href="tel:+905317273908" className="flex items-center gap-3">
                <PhoneCall className="w-5 h-5" />
                <span className="flex flex-col items-start leading-tight">
                  <span className="text-base font-normal">Sipariş Ver</span>
                  <span className="text-sm font-light opacity-95">+90 531 727 39 08</span>
                </span>
              </a>
            </Button>
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="bg-white/10 backdrop-blur-sm border-white/40 text-white hover:bg-white/20 rounded-full px-8 py-6 transition-all duration-300 hover:scale-105 h-auto"
            >
              <a href="tel:+905316535175" className="flex items-center gap-3">
                <Store className="w-5 h-5" />
                <span className="flex flex-col items-start leading-tight">
                  <span className="text-base font-light">Franchise Başvurusu</span>
                  <span className="text-sm font-light opacity-95">+90 531 653 51 75</span>
                </span>
              </a>
            </Button>
          </div>
